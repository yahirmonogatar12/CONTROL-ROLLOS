...
class _LoginScreenState extends State<LoginScreen> {
  ...
  /// Determina si mostrar el widget de configuración de servidor
  /// Se muestra siempre en Android, o en escritorio si hay múltiples servidores
  bool _shouldShowServerConfig() {
    // En móviles siempre mostrar
    if (Platform.isAndroid || Platform.isIOS) {
      return true;
    }
    // En desktop, mostrar si hay más de un servidor configurado
    // o si el usuario ha configurado algún servidor no-default
    return true; // Por ahora mostrar siempre para facilitar la configuración
  }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      ...
                      errorBuilder: (context, error, stackTrace) {
                        // Si no se encuentra el logo, mostrar un ícono
                        return Container(
                          decoration: BoxDecoration(
                ...
                // Configuración de servidor (visible en Android o si hay múltiples servidores)
                if (_shouldShowServerConfig()) ...[
                  ServerConfigWidget(
                    onServerChanged: () {
                      setState(() {
                        _errorMessage = null;
  ...
  Widget _buildLanguageButton(String label, String code) {
    ...
    return InkWell(
      onTap: () {
        ...
        setState(() {}); // Rebuild to update translations
      },
