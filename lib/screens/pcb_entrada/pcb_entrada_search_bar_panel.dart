...
class PcbEntradaSearchBarPanel extends StatefulWidget {
  ...
  final GlobalKey<PcbEntradaGridPanelState> gridKey;

  const PcbEntradaSearchBarPanel({
    super.key,
  ...
  @override
  State<PcbEntradaSearchBarPanel> createState() =>
      _PcbEntradaSearchBarPanelState();
}
